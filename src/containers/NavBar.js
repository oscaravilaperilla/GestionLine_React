import { Navbar, Nav, NavDropdown, MenuItem, NavItem,Button, Table , FormGroup, FormControl } from 'react-bootstrap';
...
export const NavBarApp = (props) => {
    return (
        ...
        <a className="navbar-brand" href="/">Gestion Line</a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            ...
            <Link to="/">
              <span className="nav-link">Home1</span>
            </Link>
            </li>
